                                ...
                                <GridItem>
                                    <Box bg="white" borderRadius="lg" boxShadow="md" p={6} transition="all 0.3s" _hover={{ boxShadow: "lg" }}>
                                        <Flex alignItems="center" mb={3}>
                                            ...
                                            <Heading as="h3" size="md" color="gray.800" p={3}>Energy Consumption</Heading>
                                        </Flex>
                                        <Stat>
                                ...
                                <GridItem>
                                    <Box bg="white" borderRadius="lg" boxShadow="md" p={6} transition="all 0.3s" _hover={{ boxShadow: "lg" }}>
                                        <Flex alignItems="center" mb={3}>
                                            ...
                                            <Heading as="h3" size="md" color="gray.800" p={3}>Execution Time</Heading>
                                        </Flex>
                                        <Stat>
                                            <StatNumber fontSize="3xl" fontWeight="bold" color="gray.900">
                                ...
                                <GridItem>
                                    <Box bg="white" borderRadius="lg" boxShadow="md" p={6} transition="all 0.3s" _hover={{ boxShadow: "lg" }}>
                                        <Flex alignItems="center" mb={3}>
                                            ...
                                            <Heading as="h3" size="md" color="gray.800" p={3}>Memory Usage</Heading>
                                        </Flex>
                                        <Stat>
                                            <StatNumber fontSize="3xl" fontWeight="bold" color="gray.900">
                                ...
                                <Flex flexWrap="wrap" gap={2} mb={4}>
                                    {Object.keys(project.suggestions).map((key) => (
                                        <Flex key={key} alignItems="center" gap={1}>
                                            ...
                                            <ArrowRight size="16px" color="gray" />
